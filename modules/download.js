    ...
    constructor(dbName = ':memory:') {
      ...
      try{
        this.db = await sqlite.open(dbName)
			  ...
			  const sql = 'CREATE TABLE IF NOT EXISTS files(downloadId INTEGER PRIMARY KEY AUTOINCREMENT, receiverEmail TEXT, senderId INTEGER, filePath TEXT, fileName TEXT,' + 
